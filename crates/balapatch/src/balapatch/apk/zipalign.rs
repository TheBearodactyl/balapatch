...
// 
// pub fn align_zip(input_path: &str, output_path: &str, alignment: u32, force: bool) -> Result<()> {
//     if !force && std::path::Path::new(output_path).exists() {
//         return Err(anyhow!("Output file '{}' exists", output_path));
//     }
// 
...
//         let padding = (alignment as u64 - (data_start % alignment as u64)) % alignment as u64;
// 
...
// pub fn verify_zip(input_path: &str, alignment: u32, verbose: bool) -> Result<bool> {
...
//             if data_start % alignment as u64 != 0 {
//                 if verbose {
//                     println!(
//                         "{:8} {} (BAD - mod {} = {})",
//                         data_start,
